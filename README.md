...
<head>
    ...
    <style>
        * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        .yt-img { width: 65px; height: 65px; border-radius: 50%; border: 3px solid #ff004d; object-fit: cover; background: #222; display: block; }
        .yt-status { width: 14px; height: 14px; background: #00ff00; border: 2px solid #080808; border-radius: 50%; position: absolute; bottom: 4px; right: 4px; box-shadow: 0 0 10px #00ff00; }
        ...
        .avatar, .current-user-av { width: 35px; height: 35px; border-radius: 50%; border: 1.5px solid #ff004d !important; object-fit: cover; background: #333; flex-shrink: 0; display: block !important; }
...
<body>
    ...
    <a href="https://youtube.com" target="_blank" class="top-yt-link">
        <!-- ТУТ ТВОЙ АНГЕЛОЧЕК (ТЕПЕРЬ ОН ЧАСТЬ КОДА) -->
